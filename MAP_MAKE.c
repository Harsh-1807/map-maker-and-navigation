...
struct Graph *createGraph(int V)
{
    ...
    for (int i = 0; i < V; i++)
    {
        graph->adjList[i] = NULL;                //assigned to NULL
    }
    return graph;
}

// Function to add an edge to the graph
void addEdge(struct Graph *graph, int src, int dest, int distance, enum Direction direction)      //source and destination
{
    if (src >= 0 && dest >= 0)
    {
...
4. Exit
Enter your choice: 1
Enter edge (source, destination, distance, and direction): 3
4
2
right
...
4. Exit
Enter your choice: 2
Enter the filename to save the map: test1
...
Adjacency list of vertex 3: 4 (2, right) -> NULL
Adjacency list of vertex 4: NULL
Adjacency list of vertex 5: NULL
Adjacency list of vertex 6: NULL
Adjacency list of vertex 7: NULL
Adjacency list of vertex 8: NULL
Adjacency list of vertex 9: NULL
*/